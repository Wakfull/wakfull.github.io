...
export class GlossaryService {
    ...
    wordList: { word:string, definition:string }[] = [
      ...
      { word:"Brèche", definition: "Les brèches sont un type de contenu proposant des combats longs, où il est possible d'affronter des \"vagues\" de monstres pendant 40 tours. Elles sont particulièrement appréciées pour l'xp qu'elles apportent." },
      ...
      { word:"Mode Héro", definition: "Il s'agit de la possibilité de jouer jusqu'à trois personnage du compte en même temps dans son groupe. Cette fonctionalité est réservée aux comptes sous Booster (= l'abonnement)." },
      ...
      { word:"AOE", definition: "\"Area Of Effect\". Ce sont les sorts de zone, tous les sorts qui tapent sur plusieurs cases en même temps. Par exemple la flêche explosive du cra." },
    ];
  ...
  getWordList():{ word:string, definition:string }[]{
    // Return a copy of the word list to prevent direct mutations
